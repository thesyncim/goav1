...
| Decoder profiles | Profile 0 and Profile 1 pass committed/vendored strict-MD5 gates; Profile 2 has passing 4:2:2 8/10/12-bit plus 4:2:0 and 4:4:4 12-bit profile clips, including 10/12-bit 4:2:2 and 12-bit 4:4:4 inter CDEF/restoration, with wider 12-bit breadth still expanding |
...
| `make dryrun-profiles` | 41/41 vendored profile clips pass, including profile-0 S_FRAME, profile-1 4:4:4, profile-2 4:2:2 8/10/12-bit, profile-2 4:4:4 12-bit, targeted 12-bit profile-2, 10/12-bit 4:2:2 and 12-bit 4:4:4 inter CDEF/restoration, super-res, film grain, edge-motion, and non-SVC multi-tile clips |
