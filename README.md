...
| Tile groups | Single and multi-tile groups pass current strict-MD5 gates; tile-list OBUs parse, validate source reference anchors/uniform decode layout, and expose libaom-shaped output geometry/copy regions, but playback/reconstruction is not wired yet |
