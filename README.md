...
- `VideoEncoder` / `RTCEncoder` is the friendly realtime pixel encoder. It
  ...
  monochrome lossless keyframes are exposed separately via
  `EncodeI400HighBitDepthLosslessKeyframe`.
