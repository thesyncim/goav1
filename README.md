...
profile corpus is green (`make dryrun-profiles`: 34/34), including
...
inter superres, 10-bit superres plus loop restoration, profile-2 4:2:2
8/10-bit, and profile-2 4:2:0 12-bit edge-size, film-grain, and superres
clips.
