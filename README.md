...
transport-wide-cc, absolute-send-time, video-content-type, and video-timing
...
| Area | Status |
| --- | --- |
| Containers and transport | IVF, AV1 low-overhead OBU, Annex B, Section 5 temporal units, AV1 RTP payload parse/build/fragment/reassemble, AV1 SDP/fmtp/profile/level/tier/extmap/RID/simulcast/rtcp-fb helpers, RTP MID/RID/CVO/playout-delay/TWCC/absolute-send-time/video-content-type/video-timing payload helpers, RTCP NACK/PLI/FIR and AV1 LRR feedback helpers |
