...
- `VideoEncoder` / `RTCEncoder` is the friendly realtime pixel encoder. It
  ...
  entering the current 8-bit realtime encode path. Native 10/12-bit
  monochrome keyframes and P-frames are exposed separately via
  `EncodeI400HighBitDepthKeyframe` and `EncodeI400HighBitDepthPFrame`.
