...
profile corpus is green (`make dryrun-profiles`: 35/35), including
profile-1 4:4:4 8/10-bit all-intra, inter, palette, CDEF/restoration,
odd edge-size CDEF/restoration, edge-motion, film grain, 10-bit inter
multi-tile, all-key superres, inter superres, 10-bit superres plus loop
restoration, profile-2 4:2:2 8/10-bit, and profile-2 4:2:0 12-bit edge-size,
film-grain, and superres clips.
