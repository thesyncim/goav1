...
`EncoderWebRTCRTCPFeedbackRequiresKeyFrame` classifies parsed PLI/FIR/LRR
feedback into the existing `forceKey` argument when a full refresh is the
desired safe response. For ordered RTP payload bodies,
