...
// caller-owned RTP sizing, RTCP NACK/Transport-CC/PLI/FIR/REMB FCI helpers,
// AV1 RTCP Layer Refresh Request FCI list helpers, sequence-header parsing,
// caller-owned frame pools
