...
// inward. Public helpers expose low-overhead, temporal-unit, and Annex B OBU
// parsing, AV1 RTP payload iteration, construction, caller-owned RTP sizing,
// and sequence-header parsing. The decoder and encoder APIs will grow at this
// top level as the internal pipeline stabilizes.
//
