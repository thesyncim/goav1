...
- `make dryrun-extended`: 226/226 opt-in diagnostic vectors pass,
  ...
  streams.
- `make dryrun-profiles`: 41/41 vendored profile clips pass, covering
  ...
  profile 2 4:4:4 12-bit edge-size and inter CDEF/restoration,
...
1. **Broader real-world/profile corpus.** Keep expanding the local generated
   ...
   tiled, super-res, film-grain, and real-content profile-2 12-bit
