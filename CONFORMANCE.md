...
- **Encoder.** The friendly realtime encoder emits AV1 bitstreams for 8-bit I420
  ...
  negotiation parameters, RTP header-extension mapping checks, AV1 RID receiver
  restrictions, AV1 simulcast RID groups, and AV1 RTCP LRR layer-grid
  validation for caller-supplied frame payloads. High-bit-depth input encoding,
  non-4:2:0
