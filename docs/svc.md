...
| WebRTC encoder native high-bit-depth monochrome     | Complete for explicit 10/12-bit monochrome single-spatial and simulcast RTC configs, including RTP dependency descriptors and reference-decoder parity after RTP assembly; shared-reference high-bit-depth SVC rejects early until scaled high-bit-depth inter-layer prediction is implemented. |
