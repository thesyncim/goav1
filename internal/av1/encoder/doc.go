...
// I422/I444/I400 and generic Frame adapters, including full multi-spatial SVC
// and simulcast pictures through EncodePicture, with runtime
...
// Native high-bit-depth and true non-4:2:0 bitstream encoding in the friendly
// pixel encoder, and broader oracle coverage remain open and should be ported
// from pinned libaom/libwebrtc behavior with
