...
// explicit single-spatial RTC configs and full multi-spatial SVC/simulcast
...
// Native high-bit-depth, true chroma non-4:2:0, and multi-spatial monochrome
// bitstream encoding in the friendly pixel encoder, plus broader oracle
// coverage, remain open and should be ported from pinned libaom/libwebrtc behavior with
