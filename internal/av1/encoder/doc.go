...
// SVC pictures through EncodePicture and native 10/12-bit monochrome lossless
// keyframes, with runtime
...
// Native high-bit-depth realtime inter/SVC and true chroma non-4:2:0 bitstream
