...
func TestHotStructSizes(t *testing.T) {
	tests := []struct {
		...
		{name: "RestorationStripeBoundaryBufferSize", size: unsafe.Sizeof(RestorationStripeBoundaryBufferSize{}), max: 16},
		{name: "RestorationFramePlan", size: unsafe.Sizeof(RestorationFramePlan{}), max: 128},
