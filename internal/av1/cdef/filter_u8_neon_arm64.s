...
//   sum       = constrain * tap                         (int16 lanes; the
...
// [min, max] clip. Each +/- tap pair and two interleaved min/max trees stay
// independent until the final fold, avoiding the original 12-result serial
// MLA/UMIN/UMAX chains. The fixed secondary weights {2,1} fold with one shift.
//
...
u8prisec8_row:
	...
	WORD $0x4eb01e03 // mov v3.16b, v16.16b (seed first max tree)
	...
	VLD1 (R16), [V4.H8]
	VLD1 (R17), [V5.H8]
	WORD $0x4ea41c86 // mov v6.16b, v4.16b (seed second min tree)
	WORD $0x6e656cc6 // umin v6.8h, v6.8h, v5.8h
	WORD $0x6e281c90 // eor v16.16b, v4.16b, v8.16b
	WORD $0x6e281cb4 // eor v20.16b, v5.16b, v8.16b
	WORD $0x4eb01e07 // mov v7.16b, v16.16b (seed second max tree)
	WORD $0x6e7464e7 // umax v7.8h, v7.8h, v20.8h
	WORD $0x6e647410 // uabd v16.8h, v0.8h, v4.8h
	WORD $0x6e657414 // uabd v20.8h, v0.8h, v5.8h
	WORD $0x6e784611 // ushl v17.8h, v16.8h, v24.8h
	WORD $0x6e784695 // ushl v21.8h, v20.8h, v24.8h
	...
	WORD $0x4e706652 // smax v18.8h, v18.8h, v16.8h
	WORD $0x4e7466d6 // smax v22.8h, v22.8h, v20.8h
	WORD $0x4e768649 // add v9.8h, v18.8h, v22.8h
	...
	WORD $0x4e706652 // smax v18.8h, v18.8h, v16.8h
	WORD $0x4e7466d6 // smax v22.8h, v22.8h, v20.8h
	WORD $0x4e76864a // add v10.8h, v18.8h, v22.8h
	...
	VLD1 (R16), [V4.H8]
	VLD1 (R17), [V5.H8]
	WORD $0x6e646cc6 // umin v6.8h, v6.8h, v4.8h
	WORD $0x6e656cc6 // umin v6.8h, v6.8h, v5.8h
	WORD $0x6e281c90 // eor v16.16b, v4.16b, v8.16b
	WORD $0x6e281cb4 // eor v20.16b, v5.16b, v8.16b
	WORD $0x6e7064e7 // umax v7.8h, v7.8h, v16.8h
	WORD $0x6e7464e7 // umax v7.8h, v7.8h, v20.8h
	WORD $0x6e647410 // uabd v16.8h, v0.8h, v4.8h
	WORD $0x6e657414 // uabd v20.8h, v0.8h, v5.8h
	WORD $0x6e7a4611 // ushl v17.8h, v16.8h, v26.8h
	...
	WORD $0x4e706652 // smax v18.8h, v18.8h, v16.8h
	WORD $0x4e7466d6 // smax v22.8h, v22.8h, v20.8h
	WORD $0x4e76864b // add v11.8h, v18.8h, v22.8h
	...
	WORD $0x4e706652 // smax v18.8h, v18.8h, v16.8h
	WORD $0x4e7466d6 // smax v22.8h, v22.8h, v20.8h
	WORD $0x4e76864c // add v12.8h, v18.8h, v22.8h
	...
	WORD $0x4e706652 // smax v18.8h, v18.8h, v16.8h
	WORD $0x4e7466d6 // smax v22.8h, v22.8h, v20.8h
	WORD $0x4e76864d // add v13.8h, v18.8h, v22.8h

	// Fold independent tap-pair sums and min/max trees.
	WORD $0x4e7c9c21 // mul v1.8h, v1.8h, v28.8h
	WORD $0x4e7d9d29 // mul v9.8h, v9.8h, v29.8h
	WORD $0x4e6b854a // add v10.8h, v10.8h, v11.8h
	WORD $0x4f11554a // shl v10.8h, v10.8h, #1 (secondary tap 0 = 2)
	WORD $0x4e6d858c // add v12.8h, v12.8h, v13.8h
	WORD $0x4e698421 // add v1.8h, v1.8h, v9.8h
	WORD $0x4e6c854a // add v10.8h, v10.8h, v12.8h
	WORD $0x4e6a8421 // add v1.8h, v1.8h, v10.8h
	WORD $0x6e666c42 // umin v2.8h, v2.8h, v6.8h
	WORD $0x6e676463 // umax v3.8h, v3.8h, v7.8h
