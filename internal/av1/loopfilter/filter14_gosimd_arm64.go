...
// 10/12-bit horizontal edges (contiguous two-byte taps). It shares the 8-bit
// kernel's structure (masks once, dav1d branch ladder, running box sums) with
// one domain change: the fourteen-tap window sum reaches 4095*16 + 8 = 65528
// at 12-bit, which overflows int16 — the NEON asm handles this by refusing
...
// and stay unbiased, as in filter8Edge16SIMD. Vertical edges reuse the NEON
// trn-ladder gather/scatter around this core; other layouts and short tails
