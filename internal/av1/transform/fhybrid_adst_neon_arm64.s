...
// NEON forward 8x8 DCT_ADST: DCT column pass, common 8x8 round shift,
// transpose, ADST row pass, and direct coeff-layout store.

// func fdctADST8x8NEONAsm(ctx *fdct8x8NEONCtx)
TEXT ·fdctADST8x8NEONAsm(SB), NOSPLIT, $0-8
	MOVD ctx+0(FP), R0
	MOVD CTXIN(R0), R1
	MOVD CTXINSTRIDE(R0), R2  // residual stride in elements
	MOVD CTXOUT(R0), R3
	...
	// ADST8 row pass for lo rows (V0,V1,V2,V3,V8,V9,V10,V11)
	WORD $0x4ea01c10 // mov v16.16b, v0.16b ; s0 = x0
	WORD $0x6ea0b971 // neg v17.4s, v11.4s ; s1 = -x7
	WORD $0x4f9a8078 // mul v24.4s, v3.4s, v26.s[0] ; s2 = half(-c32*x3 + c32*x4)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6f9a0118 // mla v24.4s, v8.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332712 // srshr v18.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a8078 // mul v24.4s, v3.4s, v26.s[0] ; s3 = half(-c32*x3 - c32*x4)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6f9a4118 // mls v24.4s, v8.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332713 // srshr v19.4s, v24.4s, #13 ; round shift Q13
	WORD $0x6ea0b834 // neg v20.4s, v1.4s ; s4 = -x1
	WORD $0x4eaa1d55 // mov v21.16b, v10.16b ; s5 = x6
	WORD $0x4f9a8058 // mul v24.4s, v2.4s, v26.s[0] ; s6 = half(c32*x2 - c32*x5)
	WORD $0x6f9a4138 // mls v24.4s, v9.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a8058 // mul v24.4s, v2.4s, v26.s[0] ; s7 = half(c32*x2 + c32*x5)
	WORD $0x6f9a0138 // mla v24.4s, v9.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4eb28600 // add v0.4s, v16.4s, v18.4s ; t0 = s0 + s2
	WORD $0x4eb38621 // add v1.4s, v17.4s, v19.4s ; t1 = s1 + s3
	WORD $0x6eb28602 // sub v2.4s, v16.4s, v18.4s ; t2 = s0 - s2
	WORD $0x6eb38623 // sub v3.4s, v17.4s, v19.4s ; t3 = s1 - s3
	WORD $0x4eb68688 // add v8.4s, v20.4s, v22.4s ; t4 = s4 + s6
	WORD $0x4eb786a9 // add v9.4s, v21.4s, v23.4s ; t5 = s5 + s7
	WORD $0x6eb6868a // sub v10.4s, v20.4s, v22.4s ; t6 = s4 - s6
	WORD $0x6eb786ab // sub v11.4s, v21.4s, v23.4s ; t7 = s5 - s7
	WORD $0x4fba8118 // mul v24.4s, v8.4s, v26.s[1] ; s4 = half(c16*t4 + c48*t5)
	WORD $0x6f9a0938 // mla v24.4s, v9.4s, v26.s[2] ; accumulate second product
	WORD $0x4f332714 // srshr v20.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a8918 // mul v24.4s, v8.4s, v26.s[2] ; s5 = half(c48*t4 - c16*t5)
	WORD $0x6fba4138 // mls v24.4s, v9.4s, v26.s[1] ; accumulate second product
	WORD $0x4f332715 // srshr v21.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a8958 // mul v24.4s, v10.4s, v26.s[2] ; s6 = half(-c48*t6 + c16*t7)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6fba0178 // mla v24.4s, v11.4s, v26.s[1] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fba8158 // mul v24.4s, v10.4s, v26.s[1] ; s7 = half(c16*t6 + c48*t7)
	WORD $0x6f9a0978 // mla v24.4s, v11.4s, v26.s[2] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x6eb48408 // sub v8.4s, v0.4s, v20.4s ; t4 = t0 - s4
	WORD $0x4eb48400 // add v0.4s, v0.4s, v20.4s ; t0 = t0 + s4
	WORD $0x6eb58429 // sub v9.4s, v1.4s, v21.4s ; t5 = t1 - s5
	WORD $0x4eb58421 // add v1.4s, v1.4s, v21.4s ; t1 = t1 + s5
	WORD $0x6eb6844a // sub v10.4s, v2.4s, v22.4s ; t6 = t2 - s6
	WORD $0x4eb68442 // add v2.4s, v2.4s, v22.4s ; t2 = t2 + s6
	WORD $0x6eb7846b // sub v11.4s, v3.4s, v23.4s ; t7 = t3 - s7
	WORD $0x4eb78463 // add v3.4s, v3.4s, v23.4s ; t3 = t3 + s7
	WORD $0x4fba8818 // mul v24.4s, v0.4s, v26.s[3] ; s0 = half(c4*t0 + c60*t1)
	WORD $0x6f9b0038 // mla v24.4s, v1.4s, v27.s[0] ; accumulate second product
	WORD $0x4f332710 // srshr v16.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9b8018 // mul v24.4s, v0.4s, v27.s[0] ; s1 = half(c60*t0 - c4*t1)
	WORD $0x6fba4838 // mls v24.4s, v1.4s, v26.s[3] ; accumulate second product
	WORD $0x4f332711 // srshr v17.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbb8058 // mul v24.4s, v2.4s, v27.s[1] ; s2 = half(c20*t2 + c44*t3)
	WORD $0x6f9b0878 // mla v24.4s, v3.4s, v27.s[2] ; accumulate second product
	WORD $0x4f332712 // srshr v18.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9b8858 // mul v24.4s, v2.4s, v27.s[2] ; s3 = half(c44*t2 - c20*t3)
	WORD $0x6fbb4078 // mls v24.4s, v3.4s, v27.s[1] ; accumulate second product
	WORD $0x4f332713 // srshr v19.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbb8918 // mul v24.4s, v8.4s, v27.s[3] ; s4 = half(c36*t4 + c28*t5)
	WORD $0x6f9c0138 // mla v24.4s, v9.4s, v28.s[0] ; accumulate second product
	WORD $0x4f332714 // srshr v20.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9c8118 // mul v24.4s, v8.4s, v28.s[0] ; s5 = half(c28*t4 - c36*t5)
	WORD $0x6fbb4938 // mls v24.4s, v9.4s, v27.s[3] ; accumulate second product
	WORD $0x4f332715 // srshr v21.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbc8158 // mul v24.4s, v10.4s, v28.s[1] ; s6 = half(c52*t6 + c12*t7)
	WORD $0x6f9c0978 // mla v24.4s, v11.4s, v28.s[2] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9c8958 // mul v24.4s, v10.4s, v28.s[2] ; s7 = half(c12*t6 - c52*t7)
	WORD $0x6fbc4178 // mls v24.4s, v11.4s, v28.s[1] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4eb11e20 // mov v0.16b, v17.16b ; out0 = s1
	WORD $0x4eb61ec1 // mov v1.16b, v22.16b ; out1 = s6
	WORD $0x4eb31e62 // mov v2.16b, v19.16b ; out2 = s3
	WORD $0x4eb41e83 // mov v3.16b, v20.16b ; out3 = s4
	WORD $0x4eb51ea8 // mov v8.16b, v21.16b ; out4 = s5
	WORD $0x4eb21e49 // mov v9.16b, v18.16b ; out5 = s2
	WORD $0x4eb71eea // mov v10.16b, v23.16b ; out6 = s7
	WORD $0x4eb01e0b // mov v11.16b, v16.16b ; out7 = s0
	// ADST8 row pass for hi rows (V4,V5,V6,V7,V12,V13,V14,V15)
	WORD $0x4ea41c90 // mov v16.16b, v4.16b ; s0 = x0
	WORD $0x6ea0b9f1 // neg v17.4s, v15.4s ; s1 = -x7
	WORD $0x4f9a80f8 // mul v24.4s, v7.4s, v26.s[0] ; s2 = half(-c32*x3 + c32*x4)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6f9a0198 // mla v24.4s, v12.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332712 // srshr v18.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a80f8 // mul v24.4s, v7.4s, v26.s[0] ; s3 = half(-c32*x3 - c32*x4)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6f9a4198 // mls v24.4s, v12.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332713 // srshr v19.4s, v24.4s, #13 ; round shift Q13
	WORD $0x6ea0b8b4 // neg v20.4s, v5.4s ; s4 = -x1
	WORD $0x4eae1dd5 // mov v21.16b, v14.16b ; s5 = x6
	WORD $0x4f9a80d8 // mul v24.4s, v6.4s, v26.s[0] ; s6 = half(c32*x2 - c32*x5)
	WORD $0x6f9a41b8 // mls v24.4s, v13.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a80d8 // mul v24.4s, v6.4s, v26.s[0] ; s7 = half(c32*x2 + c32*x5)
	WORD $0x6f9a01b8 // mla v24.4s, v13.4s, v26.s[0] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4eb28604 // add v4.4s, v16.4s, v18.4s ; t0 = s0 + s2
	WORD $0x4eb38625 // add v5.4s, v17.4s, v19.4s ; t1 = s1 + s3
	WORD $0x6eb28606 // sub v6.4s, v16.4s, v18.4s ; t2 = s0 - s2
	WORD $0x6eb38627 // sub v7.4s, v17.4s, v19.4s ; t3 = s1 - s3
	WORD $0x4eb6868c // add v12.4s, v20.4s, v22.4s ; t4 = s4 + s6
	WORD $0x4eb786ad // add v13.4s, v21.4s, v23.4s ; t5 = s5 + s7
	WORD $0x6eb6868e // sub v14.4s, v20.4s, v22.4s ; t6 = s4 - s6
	WORD $0x6eb786af // sub v15.4s, v21.4s, v23.4s ; t7 = s5 - s7
	WORD $0x4fba8198 // mul v24.4s, v12.4s, v26.s[1] ; s4 = half(c16*t4 + c48*t5)
	WORD $0x6f9a09b8 // mla v24.4s, v13.4s, v26.s[2] ; accumulate second product
	WORD $0x4f332714 // srshr v20.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a8998 // mul v24.4s, v12.4s, v26.s[2] ; s5 = half(c48*t4 - c16*t5)
	WORD $0x6fba41b8 // mls v24.4s, v13.4s, v26.s[1] ; accumulate second product
	WORD $0x4f332715 // srshr v21.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9a89d8 // mul v24.4s, v14.4s, v26.s[2] ; s6 = half(-c48*t6 + c16*t7)
	WORD $0x6ea0bb18 // neg v24.4s, v24.4s ; negate first product
	WORD $0x6fba01f8 // mla v24.4s, v15.4s, v26.s[1] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fba81d8 // mul v24.4s, v14.4s, v26.s[1] ; s7 = half(c16*t6 + c48*t7)
	WORD $0x6f9a09f8 // mla v24.4s, v15.4s, v26.s[2] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x6eb4848c // sub v12.4s, v4.4s, v20.4s ; t4 = t0 - s4
	WORD $0x4eb48484 // add v4.4s, v4.4s, v20.4s ; t0 = t0 + s4
	WORD $0x6eb584ad // sub v13.4s, v5.4s, v21.4s ; t5 = t1 - s5
	WORD $0x4eb584a5 // add v5.4s, v5.4s, v21.4s ; t1 = t1 + s5
	WORD $0x6eb684ce // sub v14.4s, v6.4s, v22.4s ; t6 = t2 - s6
	WORD $0x4eb684c6 // add v6.4s, v6.4s, v22.4s ; t2 = t2 + s6
	WORD $0x6eb784ef // sub v15.4s, v7.4s, v23.4s ; t7 = t3 - s7
	WORD $0x4eb784e7 // add v7.4s, v7.4s, v23.4s ; t3 = t3 + s7
	WORD $0x4fba8898 // mul v24.4s, v4.4s, v26.s[3] ; s0 = half(c4*t0 + c60*t1)
	WORD $0x6f9b00b8 // mla v24.4s, v5.4s, v27.s[0] ; accumulate second product
	WORD $0x4f332710 // srshr v16.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9b8098 // mul v24.4s, v4.4s, v27.s[0] ; s1 = half(c60*t0 - c4*t1)
	WORD $0x6fba48b8 // mls v24.4s, v5.4s, v26.s[3] ; accumulate second product
	WORD $0x4f332711 // srshr v17.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbb80d8 // mul v24.4s, v6.4s, v27.s[1] ; s2 = half(c20*t2 + c44*t3)
	WORD $0x6f9b08f8 // mla v24.4s, v7.4s, v27.s[2] ; accumulate second product
	WORD $0x4f332712 // srshr v18.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9b88d8 // mul v24.4s, v6.4s, v27.s[2] ; s3 = half(c44*t2 - c20*t3)
	WORD $0x6fbb40f8 // mls v24.4s, v7.4s, v27.s[1] ; accumulate second product
	WORD $0x4f332713 // srshr v19.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbb8998 // mul v24.4s, v12.4s, v27.s[3] ; s4 = half(c36*t4 + c28*t5)
	WORD $0x6f9c01b8 // mla v24.4s, v13.4s, v28.s[0] ; accumulate second product
	WORD $0x4f332714 // srshr v20.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9c8198 // mul v24.4s, v12.4s, v28.s[0] ; s5 = half(c28*t4 - c36*t5)
	WORD $0x6fbb49b8 // mls v24.4s, v13.4s, v27.s[3] ; accumulate second product
	WORD $0x4f332715 // srshr v21.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4fbc81d8 // mul v24.4s, v14.4s, v28.s[1] ; s6 = half(c52*t6 + c12*t7)
	WORD $0x6f9c09f8 // mla v24.4s, v15.4s, v28.s[2] ; accumulate second product
	WORD $0x4f332716 // srshr v22.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4f9c89d8 // mul v24.4s, v14.4s, v28.s[2] ; s7 = half(c12*t6 - c52*t7)
	WORD $0x6fbc41f8 // mls v24.4s, v15.4s, v28.s[1] ; accumulate second product
	WORD $0x4f332717 // srshr v23.4s, v24.4s, #13 ; round shift Q13
	WORD $0x4eb11e24 // mov v4.16b, v17.16b ; out0 = s1
	WORD $0x4eb61ec5 // mov v5.16b, v22.16b ; out1 = s6
	WORD $0x4eb31e66 // mov v6.16b, v19.16b ; out2 = s3
	WORD $0x4eb41e87 // mov v7.16b, v20.16b ; out3 = s4
	WORD $0x4eb51eac // mov v12.16b, v21.16b ; out4 = s5
	WORD $0x4eb21e4d // mov v13.16b, v18.16b ; out5 = s2
	WORD $0x4eb71eee // mov v14.16b, v23.16b ; out6 = s7
	WORD $0x4eb01e0f // mov v15.16b, v16.16b ; out7 = s0
...
// NEON forward 8x8 ADST_ADST: ADST column pass, common 8x8 round shift,
// transpose, ADST row pass, and direct coeff-layout store.

// func fadstADST8x8NEONAsm(ctx *fdct8x8NEONCtx)
TEXT ·fadstADST8x8NEONAsm(SB), NOSPLIT, $0-8
	MOVD ctx+0(FP), R0
	MOVD CTXIN(R0), R1
	MOVD CTXINSTRIDE(R0), R2  // residual stride in elements
	MOVD CTXOUT(R0), R3
