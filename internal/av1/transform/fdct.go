...
func ForwardDCT4x4(coeff []int32, coeffStride int, residual []int16, residualStride int) error {
	...
	forwardDCT4x4Impl(coeff, coeffStride, residual, residualStride)
	return nil
}

// forwardDCT4x4PureGo is the portable two-pass reference.
func forwardDCT4x4PureGo(coeff []int32, coeffStride int, residual []int16, residualStride int) {
...
func ForwardDCT16x16(coeff []int32, coeffStride int, residual []int16, residualStride int) error {
	...
	forwardDCT16x16Impl(coeff, coeffStride, residual, residualStride)
	return nil
}

// forwardDCT16x16PureGo is the portable two-pass reference.
func forwardDCT16x16PureGo(coeff []int32, coeffStride int, residual []int16, residualStride int) {
