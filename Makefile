...
# 4:4:4 8/10-bit, profile-2 4:2:2 8-bit and 4:2:0 12-bit, both all-intra and
# inter) and asserts byte-exact per-frame MD5 against their libaom goldens.
...
help:
	...
	@echo "  dryrun-profiles            byte-exact profile clips (profile-1 4:4:4 8/10-bit, profile-2 4:2:2/12-bit)"
